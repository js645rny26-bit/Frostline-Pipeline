...
function makeSummary(overrides: Partial<GameSummaryRow> = {}): GameSummaryRow {
  return {
    ...
    away_latent_lineup_rate: 4.5,
    home_latent_lineup_rate: 4.5,
    away_recent_form_multiplier: 1.01,
    home_recent_form_multiplier: 1.0142,
    away_active_offense_center: 4.545,
    home_active_offense_center: 4.564,
    park_runs_pct: 8,
