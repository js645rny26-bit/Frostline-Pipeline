...
export const WORKBOOK_SCHEMA: SheetDef[] = [
  ...
  // ─── COMPUTATION SECTION ────────────────────────────────────────────────────
  {
    ...
    columns: [
      ...
      { name: "Lineup_Factor", index: 12, type: "number", width: 120, format: "0.000", readOnly: true, filledBy: "MODULE_09", description: "Numeric lineup quality factor (giLineup.factor). Currently placeholder — per-player batting cross-reference not yet implemented. Will shift from a constant when the player model is live.", exampleValue: "1.000" },
...

  {
    ...
    columns: [
      ...
      { name: "Away_Lineup_Factor", index: 6, type: "number", width: 150, format: "0.000", readOnly: true, filledBy: "MODULE_09", description: "Away team numeric lineup quality factor (awayLineup.factor). Currently placeholder — per-player batting cross-reference not yet implemented.", exampleValue: "1.000" },
      { name: "Home_Lineup_Factor", index: 7, type: "number", width: 150, format: "0.000", readOnly: true, filledBy: "MODULE_09", description: "Home team numeric lineup quality factor (homeLineup.factor). Currently placeholder — per-player batting cross-reference not yet implemented.", exampleValue: "1.000" },
...

  {
    ...
    columns: [
      ...
      { name: "Variance_from_Projection", index: 7, type: "number", width: 150, format: "0.00", readOnly: true, filledBy: "FORMULA", description: "Model − Market. Positive = OVER edge; negative = UNDER edge.", exampleValue: "-2.48" },
      { name: "Direction", index: 8, type: "string", width: 100, readOnly: true, filledBy: "FORMULA", description: "OVER | UNDER | NONE — derived from sign of variance", exampleValue: "UNDER" },
      { name: "Decision", index: 9, type: "string", width: 100, readOnly: true, filledBy: "FORMULA", description: "CORE or NO_CORE or PENDING. CORE = authorized bet; NO_CORE = blocked by eligibility gate.", exampleValue: "NO_CORE" },
      { name: "Confidence", index: 10, type: "percent", width: 110, format: "0%", readOnly: true, filledBy: "FORMULA", description: "Based on variance magnitude", exampleValue: "0.35" },
      { name: "Expected_ROI", index: 11, type: "percent", width: 120, format: "0.0%", readOnly: true, filledBy: "FORMULA", description: "If CORE: |variance| × 0.05. Always positive — direction tells you which side.", exampleValue: "0.124" },
