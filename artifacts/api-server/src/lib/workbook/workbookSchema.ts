...
export const WORKBOOK_SCHEMA: SheetDef[] = [
...

  {
    ...
    columns: [
      ...
      { name: "Decision", index: 9, type: "string", width: 100, readOnly: true, filledBy: "FORMULA", description: "CORE or NOT_CORE", exampleValue: "NOT_CORE" },
      ...
      { name: "Recommendation", index: 12, type: "string", width: 150, readOnly: true, filledBy: "FORMULA", description: "STRONG_BUY, BUY, HOLD, PASS", exampleValue: "PASS" },
      { name: "Notes", index: 13, type: "string", width: 200, filledBy: "OPERATOR", exampleValue: "" },
    ],
  },

  {
    ...
    columns: [
      ...
      { name: "Recommendation", index: 10, type: "string", width: 150, readOnly: true, filledBy: "FORMULA", description: "STRONG_BUY, BUY, HOLD, PASS", exampleValue: "STRONG_BUY" },
