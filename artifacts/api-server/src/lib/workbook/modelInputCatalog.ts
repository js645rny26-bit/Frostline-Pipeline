...
const ENTRIES: ModelInputCatalogEntry[] = [
  ...
  },
  {
    ...
    refreshCadence: "EVERY_PREGAME_RUN", freshnessEvidence: "Module 02d damage_metric_status + STATCAST_SHADOW_AUDIT",
    workbookLocation: "STATCAST_SHADOW_AUDIT; COLLISION_CALIBRATION_HISTORY; GAME_SUMMARY reserved damage fields", feedsActiveProjection: "NO", feedsDecisionBoard: "NO",
    ...
    notes: "Existing non-zero shadow damage estimates remain research-only. Promotion requires a cutoff-safe exact-lineup source, dependency audit, replay, regression review, and prospective shadow validation.", freshnessKey: "SAVANT_BATTER_SEASON",
  },
  {
