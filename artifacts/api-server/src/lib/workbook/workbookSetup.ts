...
export async function repairWorkbookSchemaReference(
  ...
  const readmeRows: string[][] = [
    ...
    ["Postgame_Diagnostics", "ALLOCATION_SETTLEMENT_DIAGNOSTICS, STARTER_OUTCOME_DIAGNOSTICS, BULLPEN_TIMING_DIAGNOSTICS, and FULL_LADDER_SETTLEMENT explain who scored and why from legitimate frozen packets plus official finals. They never alter projections, vehicles, prices, or authorization."],
